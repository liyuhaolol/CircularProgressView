...
centralPortal {
    ...
    pom {
        //packaging = "aar"
        name = "CircularProgressView"
        description = "CircularProgressView"
        url = "https://github.com/liyuhaolol/CircularProgressView"
        licenses {
            license {
                name = "The MIT License"
                url = "https://github.com/liyuhaolol/CircularProgressView/blob/master/LICENSE"
            }
        }
        developers {
            developer {
        ...
        scm {
            connection = "scm:git@github.com/liyuhaolol/CircularProgressView.git"
            developerConnection = "scm:git@github.com/liyuhaolol/CircularProgressView.git"
            url = "https://github.com/liyuhaolol/CircularProgressView"
        }
